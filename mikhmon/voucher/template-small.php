...
<?php if($usermode == "vc"){?>
        ...
        <tr style="color: black; font-size: 14px;">
          <td style="width:100%; border: 1px solid black; font-weight:bold;"><?php echo tikras_h($username);?></td>
        </tr>
        <tr>
...
<?php }elseif($usermode == "up"){?>
        ...
        <tr style="color: black; font-size: 14px;">
          <td style="border: 1px solid black; font-weight:bold;"><?php echo tikras_h($username);?></td>
          <td style="border: 1px solid black; font-weight:bold;"><?php echo tikras_h($password);?></td>
        </tr>
        <tr>
          <td colspan="2" style="border: 1px solid black; font-weight:bold;"><?php echo $validity;?> <?php echo $timelimit;?> <?php echo $datalimit;?> <?php echo $price;?></td>
        </tr>
