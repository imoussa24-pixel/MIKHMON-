...
<?php if ($usermode == "vc") { ?>
        ...
        <tr>
          <td style="width:100%; border: 1px solid black; font-weight:bold; font-size:16px;"><?= tikras_h($username); ?></td>
        </tr>
<!-- /  -->
<!-- Username & Password  -->
<?php 
...
<?php if ($qr == "yes") { ?>
        ...
        <tr>
          <td style="border: 1px solid black; font-weight:bold;"><?= tikras_h($username); ?></td>
        </tr>
        <tr>
          <td>Password</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; font-weight:bold;"><?= tikras_h($password); ?></td>
        </tr>
<?php 
} else { ?>
        <tr>
